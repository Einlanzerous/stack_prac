...
#People in game
player1 = Person("Ricas:", 460,  60, 60, 34, player_magic, player_items)
player2 = Person("Jade :", 335,  90, 40, 20, player_magic, player_items)
player3 = Person("Ryuji:", 550,  40, 90, 54, player_magic, player_items)

enemy = Person("Minotaur", 2800, 65, 80, 25, None, None)
...
while running:
    ...
    if enemy.get_hp() == 0:
        ...
        print(bcolors.FAIL + "You dead son!" + bcolors.ENDC)
        running = False
